...
import hero00 from "./Hero00.jpg";
import footer from "./footer.jpg";
import woman1 from "./woman1.jpg";
import child1 from "./child1.jpg";
import fash1 from "./fash1.jpg";  
import photo1 from "./photo1.jpg";  
import display1 from "./display1.jpg";  
import asoofi1 from "./asoofi1.jpg";
import asoofi2 from "./asoofi2.jpg";  
import asoofi3 from "./asoofi3.jpg";  
...
export const productsDummyData = [
  {
    ...
    "name": "Striped Atiku Utility Co-Ord",
    "description": "This Striped Atiku Co-Ord Set blends modern elegance with traditional flair. Designed with a tailored fit, it features a crisp button-up top and utility-style pockets for a touch of edge.",
    "price": 333.00,
    "offerPrice": 333.00,
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Kaftan Gown",
    "description": "The Celestial Bloom Boubou is a stunning fusion of elegance and tradition. Crafted from premium floral-patterned lace with metallic accents, it features a flowing silhouette and soft puff sleeves that offer both comfort and style.",
    "price": 333.00,
    "offerPrice": 333.00,
    "image": [white1, white2]
    ,
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "The Emerald Ember Gown",
    "description": "The Emerald Ember Gown is a breathtaking blend of tradition and high fashion. Featuring a fitted green lace bodice adorned with intricate embroidery and long sleeves, it flows seamlessly into a dramatic burnt-orange mermaid-style train.",
    "price": 333.00,
    "offerPrice": 333.00,
    "image": [green1, green2, green3],
    "category": "Women",
    "date": 28/8/2025,
    "__v": 0
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "The Royal Azure Aso-Oke",
    "description": "The Royal Azure Aso-Oke Ensemble radiates pure sophistication and cultural pride. Crafted with a striking combination of richly embroidered lace and a luxurious satin wrapper, this outfit features intricate beadwork and sheer sleeves that add modern elegance to a timeless silhouette. The regal gele (head tie) is styled in layered folds for a bold finish, while the matching ipele drapes gracefully over the shoulder. Paired with a crystal-embellished clutch, this look is perfect for weddings, traditional engagements, or high-society events — a true symbol of grace and heritage.",
    "price": 333.00,
    "offerPrice": 333.00,
    "image": [high1, high2, high3],
    "category": "Women",
    "date": 28/8/2025,
    "__v": 0
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Modern Omoluabi",
    "description": "Embodying the essence of elegance, tradition, and refinement, the Modern Omoluabi ensemble redefines Yoruba sophistication. This regal look features a richly beaded lace dress paired with a lustrous royal blue aso-oke wrapper and gele, crafted to perfection. The structured headwrap and intricately detailed sleeves highlight a graceful presence, while a crystal-clear clutch adds a modern edge. Designed for the woman who honors her roots while embracing style, this outfit is perfect for weddings, traditional engagements, and cultural ceremonies.",
    "offerPrice": 499.99,
    "image": [asoofi1, asoofi2, asoofi3],
    "category": "Men",
    "date": 28/8/2025,
    "__v": 0
  },
  {
    ...
    "description": "A coordinated couple's look that speaks volumes in subtlety — where deep hues meet intentional embroidery for a timeless, regal finish. Perfect for pre-wedding shoots, introductions, or cultural celebrations.",
    "offerPrice": 3899.99,
    "image": [photo1],
    "category": "Men, Women",
    "date": 28/8/2025,
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Midnight Bloom",
    "description": "Step into refined elegance with Midnight Bloom — a chic black mini dress featuring a dramatic off-shoulder neckline adorned with a powder-blue petal-like overlay. The sleek silhouette hugs the body gracefully, making it a perfect choice for cocktail events, evening soirées, or upscale dinners. Paired with statement heels and delicate jewelry, this look captures the essence of modern glam with a soft, feminine edge.",
    "price": 2799.99,
    "offerPrice": 2499.99,
    "image": [fash1],
    "category": "Women",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Scarlet Radiance",
    "description": "Make a bold statement in Scarlet Radiance — a rich red satin dress designed to turn heads. This figure-hugging piece features dramatic ruched detailing along the sides and delicate feather accents at the sleeves, blending playful charm with luxurious sophistication",
    "price": 349.99,
    "offerPrice": 299.99,
    "image": [display1],
    "category": "Women",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Urban Explorer",
    "description": "Perfect for little adventurers, this stylish outfit blends comfort with bold patterns—ready to take on the city in confidence and style.",
    "price": 1699.99,
    "offerPrice": 1499.99,
    "image": [child1],
    "category": "Men",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Elegant African Royalty",
    "description": "A majestic ensemble that captures the essence of African heritage with a modern twist. Featuring a richly embroidered lace top paired with a flowing satin wrapper and a regal gele, this outfit is perfect for weddings, traditional ceremonies, and high-profile events. The intricate beadwork and luxurious fabrics exude sophistication and cultural pride, making it a standout choice for those who appreciate timeless elegance.",
    "price": 2199.99,
    "offerPrice": 1999.99,
    "image": [woman1],
    "category": "Laptop",
